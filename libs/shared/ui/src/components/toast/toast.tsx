...
const toastVariants = cva(
	...
	],
	{
		variants: {
			position: {
				"top-center": "-translate-x-1/2 start-1/2 top-0 after:top-full",
				"top-right": "end-0 top-0 after:top-full",
				"top-left": "start-0 top-0 after:top-full",
				"bottom-center":
					"-translate-x-1/2 start-1/2 bottom-0 after:bottom-full",
...
const toastContainerVariants = cva(["fixed z-50 flex flex-col gap-2"], {
	variants: {
		position: {
			"top-center": "-translate-x-1/2 end-1/2 top-3",
			"top-right": "end-3 top-3",
			"top-left": "start-3 top-3",
			"bottom-center": "-translate-x-1/2 end-1/2 bottom-3",
